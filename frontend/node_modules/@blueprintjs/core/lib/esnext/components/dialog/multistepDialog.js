...
let MultistepDialog = class MultistepDialog extends AbstractPureComponent2 {
    constructor() {
        ...
        this.renderDialogStep = (step, index) => {
            ...
            return (React.createElement("div", { className: classNames(Classes.DIALOG_STEP_CONTAINER, { [Classes.ACTIVE]: hasBeenViewed }), key: index },
                React.createElement("div", { className: Classes.DIALOG_STEP, onClick: this.handleClickDialogStep(index) },
                    ...
                    React.createElement("div", { className: classNames(Classes.DIALOG_STEP_TITLE, { [Classes.ACTIVE]: currentlySelected }) }, step.props.title))));
        };
    ...
    render() {
        return (React.createElement(Dialog, Object.assign({}, this.props, { style: this.getDialogStyle() }),
    ...
    renderButtons() {
        ...
        if (this.state.selectedIndex > 0) {
            buttons.push(React.createElement(Button, Object.assign({ key: "back", onClick: this.getDialogStepChangeHandler(selectedIndex - 1), text: "Back" }, this.props.backButtonProps)));
        }
        if (selectedIndex === this.getDialogStepChildren().length - 1) {
            ...
            buttons.push(React.createElement(Button, Object.assign({ intent: "primary", key: "next", onClick: this.getDialogStepChangeHandler(selectedIndex + 1), text: "Next" }, this.props.nextButtonProps)));
        }
        return buttons;
    }
